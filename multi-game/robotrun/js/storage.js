const StorageManager = {
  ...
  createSession(name, charName, difficulty = 'normal', boardData = null, gameMode = 'hotseat', playerCount = 2, checkpointsCount = null, startingLives = null, extras = null) {
    ...
    const newSession = {
      ...
      gameMode,
      playerCount,
      playTransport: gameMode === CONFIG.GAME_MODES.P2P
        ? CONFIG.PLAY_TRANSPORTS.P2P
        : CONFIG.PLAY_TRANSPORTS.LOCAL,
      p2pRoomCode: extra.p2pRoomCode || null,
      p2pHostId: extra.p2pHostId || null,
      p2pSeed: extra.p2pSeed || null,
      gameState: null,
      checkpoint: 1,
      wins: 0,
      active: true,
  ...
  normalizeGameMode(session) {
    ...
    if (session.gameMode === CONFIG.GAME_MODES.P2P || session.playTransport === CONFIG.PLAY_TRANSPORTS.P2P) {
      return CONFIG.GAME_MODES.P2P;
    }
    return CONFIG.GAME_MODES.HOTSEAT;
  },

  isP2pSession(session) {
    return this.normalizeGameMode(session) === CONFIG.GAME_MODES.P2P;
  }
};
