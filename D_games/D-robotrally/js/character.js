const CharacterManager = {
  ...
  save() {
    ...
    if (
      typeof MatrixSessionController !== 'undefined'
      && MatrixSessionController.isActive?.()
      && MatrixSessionController.lobby?.status === 'lobby'
    ) {
      const player = this.players[this.activeIndex];
      MatrixSessionController.updateLocalSeatProfile(player).catch(() => {});
    }
  },
